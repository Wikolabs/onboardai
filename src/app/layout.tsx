...
export const metadata: Metadata = { title: "OnboardAI — Onboarding automatise, activation client en 24h", description: "+68% activation J1, -70% time-to-value. OnboardAI guide chaque nouvel utilisateur vers son premier succes sans intervention manuelle." };
