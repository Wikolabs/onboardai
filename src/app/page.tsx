...
const P = {
  ...
  palette: {
    ...
    accentBorder: "rgba(3,105,161,0.30)",
    accentGlow: "rgba(3,105,161,0.15)",
    navBg: "rgba(239,246,255,0.86)",
  },
  content: {
    fr: {
      langLabel: "FR",
      ...
      metrics: [
        { value: "+68%", label: "activation J1" },
        { value: "-70%", label: "time-to-value" },
        { value: "3x", label: "retention 30j" },
        { value: "100%", label: "automatise" },
      ],
      features: [
        { icon: "🗺️", title: "Parcours adaptatif IA", desc: "OnboardAI construit un parcours personnalise pour chaque utilisateur selon son profil, son role et ses actions dans l'application." },
        { icon: "📧", title: "Emails comportementaux", desc: "Chaque email declenche au bon moment, base sur ce que l'utilisateur a fait ou n'a pas fait — pertinent, utile, non intrusif." },
        { icon: "🚩", title: "Detection milestones auto", desc: "OnboardAI detecte les jalons cles et adapte le parcours en temps reel — premier export, premiere integration, premier rapport." },
      ],
      steps: [
      ...
      persuasion: {
        ...
        title: "Les trois quarts de vos signups n'atteindront jamais leur aha moment.",
        paragraphs: [
          { type: "pathos", text: "Jeudi 14h32. Vous regardez le tableau Mixpanel de votre cohorte de la semaine derniere. 412 signups, 287 ont active leur compte, 94 ont termine l'onboarding, 31 ont fait l'action cle de votre produit, et lundi prochain il en restera peut-etre 12 actifs. Vous savez exactement ou ils decrochent — etape 3, integration Slack, ils ne trouvent pas la cle API. Vous l'avez su le mois dernier aussi. Et celui d'avant. Mais entre la roadmap produit, le sprint retention et les nouveaux features demandes par les sales, le fix de l'onboarding reste en backlog depuis le Q2." },
          { type: "logos", text: "Wyzowl a mesure en 2025 que 86% des utilisateurs SaaS B2B abandonnent dans les 7 premiers jours s'ils n'atteignent pas leur premier moment de valeur. Gartner indique que reduire le time-to-value de 50% augmente la LTV de 2.4x. McKinsey rapporte que les SaaS avec onboarding automatise par IA voient leur activation J1 grimper de 60 a 75% en moyenne. Le onboarding manuel scripte est devenu un goulot d'etranglement structurel des qu'on depasse 500 signups/mois." },
          { type: "ethos", text: "Wikolabs construit des agents IA en production depuis 2023 pour des scale-ups B2B, family offices et fintechs reglementees. Nous avons brule nos doigts sur les memes problemes que vous : pipelines qui hallucinent, briefs ignores, dashboards desertes. OnboardAI est ce que nous avons construit pour nos propres clients exigeants avant de le proposer au marche." },
          { type: "solution", text: "Concretement : vous installez le SDK OnboardAI en 30 minutes, il observe vos cohortes actuelles pour identifier les jalons d'activation et les points de churn, puis prend le relais. Chaque nouveau signup recoit un parcours adapte a son role, son segment et ses actions in-app — emails intelligents au bon moment, checklists contextuelles, nudges quand il bloque. Resultat : +68% d'activation J1, -70% de time-to-value, 3x de retention a 30 jours." },
        ],
      },
      ...
      footerTagline: "Onboarding IA pour SaaS B2B",
    },
    en: {
      langLabel: "EN",
      tagLabel: "Automated onboarding · Accelerated activation · AI",
      taglines: ["New customers.", "Activated in 24h.", "Zero manual work."],
      taglineAccentIdx: 1,
      desc: "OnboardAI guides every new user to their first success in 24h — personalized journey, smart emails, milestones detected automatically.",
      navLinks: [
      ...
      metrics: [
        { value: "+68%", label: "D1 activation" },
        { value: "-70%", label: "time-to-value" },
        { value: "3x", label: "30-day retention" },
        { value: "100%", label: "automated" },
      ],
      features: [
        { icon: "🗺️", title: "Adaptive AI journey", desc: "OnboardAI builds a personalized path for every user based on their profile, role and in-app actions." },
        { icon: "📧", title: "Behavioral emails", desc: "Every email fires at the right moment, based on what the user did or didn't do — relevant, useful, non-intrusive." },
        { icon: "🚩", title: "Auto milestone detection", desc: "OnboardAI detects key milestones and adapts the journey in real time — first export, first integration, first report." },
      ],
      steps: [
        { num: "01", title: "Connect your app", desc: "Lightweight SDK installed in 30 minutes. OnboardAI starts tracking activation events immediately." },
        { num: "02", title: "Behavior analysis", desc: "OnboardAI identifies activation milestones, friction points and patterns of users who succeed vs churn." },
        { num: "03", title: "Automated journeys live", desc: "Every new user receives a tailor-made path — in-app, email, checklist — to their first moment of value." },
      ],
      persuasion: {
        sectionTag: "Why now",
        title: "Three-quarters of your signups will never reach their aha moment.",
        paragraphs: [
          { type: "pathos", text: "Thursday 2:32pm. You're staring at last week's cohort dashboard in Mixpanel. 412 signups, 287 activated, 94 finished onboarding, 31 did the key action, and by next Monday maybe 12 will still be active. You know exactly where they drop — step 3, Slack integration, they can't find the API key. You knew it last month. And the month before. But between product roadmap, the retention sprint and the new features sales is asking for, the onboarding fix has been in the backlog since Q2." },
          { type: "logos", text: "Wyzowl measured in 2025 that 86% of B2B SaaS users churn within 7 days if they don't reach their first moment of value. Gartner indicates that cutting time-to-value by 50% lifts LTV 2.4x. McKinsey reports that SaaS companies with AI-driven onboarding see D1 activation jump from 60 to 75% on average. Manual scripted onboarding has become a structural bottleneck past 500 signups/month." },
          { type: "ethos", text: "Wikolabs has been building production AI agents since 2023 for B2B scale-ups, family offices and regulated fintechs. We burned our fingers on the same problems you face: hallucinating pipelines, ignored briefs, abandoned dashboards. OnboardAI is what we built for our own demanding customers before bringing it to market." },
          { type: "solution", text: "Concretely: you install the OnboardAI SDK in 30 minutes, it observes your current cohorts to identify activation milestones and churn points, then takes over. Every new signup receives a path adapted to their role, segment and in-app actions — smart emails at the right moment, contextual checklists, nudges when they get stuck. Result: +68% D1 activation, -70% time-to-value, 3x retention at 30 days." },
        ],
      },
      ctaTitle: "Activate your customers in 24h",
      ctaDesc: "SDK in 30 minutes. First results within 1 week. No credit card.",
      ctaPrimary: "Book a call",
      ctaWhatsApp: "WhatsApp",
      ctaDemo: "Request a demo",
      ctaSoonBadge: "Soon",
      footerTagline: "AI onboarding for B2B SaaS",
    },
  },
};
